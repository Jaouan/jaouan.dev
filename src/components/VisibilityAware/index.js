class VisibilityAware extends HTMLElement {
  ...
  constructor() {
    super();
    this.elementToObserve = this.getAttribute("data-selector")
      ? document.querySelector(this.getAttribute("data-selector"))
      : this;
      ...
      (entries) => {
        entries.forEach((entry) => {
          entry.isIntersecting
            ? this.classList.add("already-been-visible", animationCssClass)
